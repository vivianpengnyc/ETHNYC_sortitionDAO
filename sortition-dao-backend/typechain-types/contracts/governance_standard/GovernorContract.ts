...
export interface GovernorContractInterface extends utils.Interface {
  functions: {
    ...
    "i_interval()": FunctionFragment;
    "i_vrfCoordinator()": FunctionFragment;
    ...
    "s_indexesOfSelectedVoters(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "s_indexesOfSelectedVoters",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "RequestedPickVoters(uint256)": EventFragment;
    ...
    "VotersPicked(uint256[])": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RequestedPickVoters"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "VotersPicked"): EventFragment;
...
export interface RequestedPickVotersEventObject {
  requestId: BigNumber;
}
export type RequestedPickVotersEvent = TypedEvent<
  [BigNumber],
  RequestedPickVotersEventObject
>;

export type RequestedPickVotersEventFilter =
  TypedEventFilter<RequestedPickVotersEvent>;
...
export interface VotersPickedEventObject {
  winner: BigNumber[];
}
export type VotersPickedEvent = TypedEvent<
  [BigNumber[]],
  VotersPickedEventObject
>;

export type VotersPickedEventFilter = TypedEventFilter<VotersPickedEvent>;
...
export interface GovernorContract extends BaseContract {
  ...
  functions: {
    ...
    i_interval(overrides?: CallOverrides): Promise<[BigNumber]>;

    i_vrfCoordinator(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "RequestedPickVoters(uint256)"(
      requestId?: PromiseOrValue<BigNumberish> | null
    ): RequestedPickVotersEventFilter;
    RequestedPickVoters(
      requestId?: PromiseOrValue<BigNumberish> | null
    ): RequestedPickVotersEventFilter;
    ...
    "VotersPicked(uint256[])"(
      winner?: PromiseOrValue<BigNumberish>[] | null
    ): VotersPickedEventFilter;
    VotersPicked(
      winner?: PromiseOrValue<BigNumberish>[] | null
    ): VotersPickedEventFilter;
  ...
  estimateGas: {
    ...
    i_vrfCoordinator(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    i_interval(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    i_vrfCoordinator(overrides?: CallOverrides): Promise<PopulatedTransaction>;
